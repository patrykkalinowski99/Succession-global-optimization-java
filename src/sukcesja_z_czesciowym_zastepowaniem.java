...
//        }
        ...
        for (int epoka = 1; epoka <= 1000; epoka++) {
            System.out.println("\nEPOKA NR " + epoka);
            ...
            for (int i = 0; i < n; i++) {
                ...
                for (int j = 0; j < zakres_m; j++) {
                    ...
                    tab_laczona[i] += sukcesja_tab[losowe_indexy_sukcesji[i]][j];
                }
                wartosc = losowe_indexy_sukcesji[i] - 1;
                if (wartosc < 0) wartosc = 0;
                Fx[i] = Fx2[wartosc];
                System.out.print("\tFx = " + Fx2[wartosc]);
                suma+=Fx[i];
                System.out.println();
            }
            suma /= n;
            System.out.println("Srednia wartosc Fx = "+suma);
//            wartosc = 0;
