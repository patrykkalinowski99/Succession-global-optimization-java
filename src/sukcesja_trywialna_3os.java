...
public class sukcesja_trywialna_3os {
    public static void main(String[] args) {
        ...
        for (int epoka = 1; epoka <= 100; epoka++) {
            ...
            int zmienna_pomocnicza = 0, zmienna_pomocnicza2 = 0, nr = 0, nr2 = 0, nr3 = 0;
            ...
            for (int j = 0; j < n; j++) {
                ...
                while (true) {
                    ...
                    if (zmienna_pomocnicza == turniej_array[j][1] || zmienna_pomocnicza == turniej_array[j][0]) {
                        zmienna_pomocnicza = r.nextInt(n);
                        turniej_array[j][2] = zmienna_pomocnicza;
                    }
                    else
                ...
                System.out.print(nr3+".\t"+ tab_laczona[zmienna_pomocnicza3].replace("", ""));
                System.out.println("\tFx = "+Fx[zmienna_pomocnicza3]);
                if (Fx[zmienna_pomocnicza] >= Fx[zmienna_pomocnicza2]){
                    if (Fx[zmienna_pomocnicza] >= Fx[zmienna_pomocnicza3]){
                        ...
                        System.out.println("Wygrywa osobnik\tnr " + nr3);
            ...
            System.out.println("Srednia z Fx = "+suma);
...
//                System.out.println();
            ...
            suma = 0;
//            System.out.println("POPULACJA PO DOKONANIU INWERSJI dla epoki = "+epoka+" przy pm = "+prawdopodobienstwo_inwersji);
            for (int i = 0; i<n; i++){
//                System.out.print("\t");
                for (int j = 0; j<zakres_m; j++){
//                    System.out.print(populacja_array[i][j]+" ");
...
//            System.out.println("Populacja po krzyżowaniu jednopunktowym dla epoki NR "+epoka+" dla n = "+n+" przy pk = "+pk);
            for (int i = 0; i<n; i++){
                for (int j = 0; j<zakres_m; j++){
